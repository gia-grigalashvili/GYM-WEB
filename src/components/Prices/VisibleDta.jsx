  ...
  return (
    <div>
      <div key={index} className="w-full mt-7">
        <div
          className="bg-[#222] lg:px-8 px-4 py-6 flex  items-center cursor-pointer justify-between rounded-[4rem] lg:rounded-[8.75rem]"
          onClick={() => handleToggle(index)}
        >
          <p className=" text-[13px] lg:text-[1.25rem] font-bold uppercase text-center text-[#C4C4C4]">
            {name}
          </p>
          <div className="bg-[#D7FD44] rounded-full w-[3rem] h-[3rem] lg:w-[5rem] lg:h-[5rem] flex items-center justify-center cursor-pointer transform scale-100 hover:scale-125 transition-transform duration-300">
            <img
              src={arrowbig}
              alt="Expand section"
